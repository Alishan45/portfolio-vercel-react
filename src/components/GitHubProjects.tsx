    ...
    return (
      <section className="py-12 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-8 dark:text-white">GitHub Projects</h2>
  ...
  return (
    <section className="py-12 bg-gradient-to-b from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30 dark:opacity-20">
        ...
        <div className="absolute w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000 bottom-0 -right-4"></div>
      </div>
        ...
        >
          {repos.map(repo => (
            <motion.a
              ...
              whileHover="hover"
              className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 backdrop-blur-sm bg-opacity-90 dark:bg-opacity-90 border border-gray-200 dark:border-gray-700"
            >
              ...
              <div className="flex items-center justify-between text-sm">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center">
                    <svg className="w-4 h-4 mr-1 text-gray-600 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20">
